...
function App() {
  ...
  const updateUserInvestment = async ( ) => {
    ...
    if (response && response.length > 0) {
      ...
      console.log("sssssssssssssssssssssssss",currentname1, currentname2)
      console.log("sssssssssssssssssssssssss",currentname1, currentname2)
      console.log("sssssssssssssssssssssssss",currentname1, currentname2)
      console.log("sssssssssssssssssssssssss",currentname1, currentname2)
      console.log("sssssssssssssssssssssssss",currentname1, currentname2)
      ...
      console.log("sssssssssssssssssssssssss",firsta1, firsta2)
      console.log("sssssssssssssssssssssssss",firsta1, firsta2)
      console.log("sssssssssssssssssssssssss",firsta1, firsta2)
      console.log("sssssssssssssssssssssssss",firsta1, firsta2)
      console.log("sssssssssssssssssssssssss",firsta1, firsta2)
        ...
        <MDBRow>
          <MDBCol sm="6">
            ...
            <div className="d-flex flex-column justify-content-center h-custom-2 w-75">
              <h3
                className="fw-normal mb-3 ps-5 pb-3 logo-login"
              ...
              <Button
                className="logo-button mb-4 px-5 mx-5 w-100"
                style={{ backgroundColor: '#350076', justifyContent: 'center', color: "white" }}
                variant="contained"
                onClick={handleLogin}
                disabled={loading}
