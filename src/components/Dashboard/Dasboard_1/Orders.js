...
const rows = [
  createData(' Hive  ', 159, 6.0, 24, 4.0),
  createData(' Trees    ', 237, 9.0, 37, 4.3),
  createData(' Bush    ', 237, 9.0, 37, 4.3),
  createData(' Animal    ', 237, 9.0, 37, 4.3),
  createData(' Land    ', 237, 9.0, 37, 4.3),
  createData(' Crops    ', 237, 9.0, 37, 4.3),
  createData(' Hive  ', 159, 6.0, 24, 4.0),
  createData(' Trees    ', 237, 9.0, 37, 4.3),
  createData(' Bush    ', 237, 9.0, 37, 4.3),
  createData(' Animal    ', 237, 9.0, 37, 4.3),
            ...
            <Table sx={{ minWidth: 700 }} aria-label="customized table">
              <TableHead style={{ position: "sticky" }}>
                <TableRow>
                  ...
                  <StyledTableCell align="left"> {t('l38')}  </StyledTableCell>
                  <StyledTableCell align="left">{t('l39')}</StyledTableCell>
              ...
              <TableBody>
                {rows.map((row) => (
                  <StyledTableRow key={row.name}>
                    ...
                    <StyledTableCell style={{ color: 'purple', fontWeight: 'bold', cursor: 'pointer' }} onClick={send} align="left" > <>{row.name}</> </StyledTableCell>
                    <StyledTableCell align="left">{row.calories}</StyledTableCell>
