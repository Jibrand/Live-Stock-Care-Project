      ...
      <Box sx={{ display: 'flex' }}>
        ...
        <AppBar position="absolute" open={open} style={{backgroundColor:"#430e7e"}}>
          <Toolbar
            ...
            {/* <IconButton onClick={handleOpenUserMenu1} color="inherit">
            ...
            <Menu
              ...
              >
               <div style={{paddingLeft:"16px",paddingRight:"50px"}}> 
                    <Typography textAlign="left" variant='body2' style={{fontSize:"18px"}}><b>Notifications</b>  </Typography>
                  
                  
                    <p textAlign="left" variant='body2' className='' style={{fontSize:"13px",color:"rgb(99, 115, 129)", marginTop:"-0px"}}>You have 2 unread messages  </p>
                 <hr/>
                 <p textAlign="left" variant='body2' className='' style={{fontSize:"13px",color:"#e5b509", marginBottom:"-5px"}}>New </p>

                 </div>  
                 <MenuItem style={{maxwidth:"10px"}}>

                 <Typography textAlign="left" variant='body2' style={{fontSize:"16px"}}><b>Your order is placed </b> waiting for shippig for shippig for shipping  </Typography>
