...
import Single_Product_Top from './Single_Product_Top';
import Single_Product_Top1 from './Single_Product_Top1';
import Single_Product_Top2 from './Single_Product_Top2';
      ...
      <Box sx={{ display: 'flex' }}>
        ...
        >
          ...
          <h1 className="teko" style={{ fontSize: "1.7em", color: "#430e7e", textAlign: "center", fontFamily: "Sans-serif" }}>
            <span className="purple"> <u>   Product Overview </u>   </span>
          </h1>
          <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
            <Grid container spacing={3}>

              <Grid item xs={12} md={12} lg={12}>
                <div className='p-2' style={{ borderRadius: "20px", backgroundColor: "white", boxShadow: "1px 1px 5px 1px #888888" }} >
                  <Single_Product_Top />
                </div>
              </Grid>
